...
public class Moon extends Celestial {
    ...
    public Moon(String name, List<Integer> colorID, double mass, double radius, PlanetaryElements elements, OrbitFactory factory) {
        super(name, colorID, mass, radius, elements, factory);
    }
